...
#' @param x 
#' @param cvd 
#' @param metric a vector of color metric specifiers. Valid values are '1976','1994', and '2000', which refer to the year the metric  was recommended by the CIE.
#' @param ...
#' 
#'
#' @return
...
#' 
palette_dist = function(x, cvd = NULL, metric = 1976, ...){
